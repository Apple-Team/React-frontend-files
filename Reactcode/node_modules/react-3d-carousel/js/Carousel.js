...
var Carousel = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement('div', { className: 'prev', onMouseOver: Util.partial(this.onRotate, +angle) }),
            React.createElement('div', { className: 'next', onMouseOver: Util.partial(this.onRotate, -angle) })
        );
    }
});
